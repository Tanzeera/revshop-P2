...
import { AiOutlineArrowLeft, AiOutlineArrowRight } from 'react-icons/ai'; // Updated import
  ...
  return (
    <Container>
      <Arrow direction='left' onClick={() => handleClick('left')}>
        <AiOutlineArrowLeft /> {/* Updated icon */}
      </Arrow>
        ...
        {slideItems.map((item) => (
          <Slide bg={item.bg} key={item.id}>
            ...
            <InfoContainer>
              ...
              <Desc>{item.desc}</Desc>
              <ButtonContainer>
                <OutlinedButton text={'SHOP NOW'} link={'/home/shop'} />
              </ButtonContainer>
            </InfoContainer>
          </Slide>
        ))}
      ...
      <Arrow direction='right' onClick={() => handleClick('right')}>
        <AiOutlineArrowRight /> {/* Updated icon */}
      </Arrow>
    </Container>
  );
};
