...
export default function Footer() {
  ...
  const handleSubscribe = async () => {
    ...
    try {
      // Placeholder for future API integration to save subscriber information
      // For now, you can replace this with an API call when ready
      console.log("Subscriber added to the database (future implementation)");
    ...
    <>
      ...
      >
        <div className="lg:col-span-2 h-full w-full p-2 sm:p-0">
          <img
            src="https://pop-shop-github.vercel.app/images/footer.jpg"
            alt="footer image"
        ...
        <div className="grid grid-rows-4 w-full lg:col-span-3 max-sm:px-4">
          ...
          <div className="mt-12 border-t border-gray-100 flex flex-wrap max-sm:text-left items-center justify-between pt-8 space-8 gap-x-8">
            ...
            <p className="text-xs text-gray-500">
              &copy; {year}. Made with ❤️ by RevShop.com. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
